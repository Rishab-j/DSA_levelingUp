...
public class l001{
    ...
    public static ArrayList<String> nokiaKeyPad_01(String str,int idx){
        if(idx == str.length()){
            ArrayList<String> base = new ArrayList<>();
            base.add("");
            return base;
        ...
        ArrayList<String> smallAns = nokiaKeyPad_01(str,idx+1);
    ...
    public static void set3(){
        ...
        // subsequence("abc","");
        System.out.println(nokiaKeyPad("11345",0,""));
